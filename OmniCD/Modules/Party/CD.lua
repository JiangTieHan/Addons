...
registeredEvents['SPELL_CAST_SUCCESS'][408233] = function(info, srcGUID, _, destGUID)
...
local function ReduceDirectDamageCD(info, _,_,_, critical, _,_,_,_,_,_, timestamp)

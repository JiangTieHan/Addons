...
V =
    C == "zhCN" and { -- 94/94 (100%)
      ...
      "心能不足", "精英", "稀有", "没什么效果。", "没有考虑到所有的技能。", "未检验全部结果。", "预估：", "数量：%s", "所有敌人下轮造成的伤害降低{}%。", "所有敌人两轮内造成的伤害减少{}%。", "使最近盟友两轮受到的伤害降低50%。", "敌人剩余生命值：%s",
    ...
    or C == "zhTW" and { -- 94/94 (100%)
      ...
      "心能不足", "精英", "稀有", "沒什么效果。", "沒有考慮到所有的技能。", "未檢驗全部結果。", "預估：", "數量：%s", "所有敵人下輪造成的傷害降低{}%。", "所有敵人兩輪內造成的傷害減少{}%。", "使最近盟友兩輪受到的傷害降低50%。", "敵人剩余生命值：%s",
